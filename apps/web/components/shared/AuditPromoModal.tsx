...
export function AuditPromoModal(): React.ReactElement | null {
  ...
  return (
    ...
    >
      ...
      <div
        ref={panelRef}
        className="w-full h-full bg-surface overflow-y-auto animate-in fade-in flex flex-col"
      >
        {/* Dark hero section — fills top half */}
        <div className="bg-ink px-8 pt-16 pb-12 text-center relative flex-1 flex flex-col items-center justify-center min-h-[45vh]">
          {/* Close */}
          <button
            type="button"
            onClick={handleClose}
            className="absolute top-6 right-6 p-2 rounded-sm text-white/50 hover:text-white transition-colors duration-fast focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-ink"
            aria-label="Close"
          >
          ...
          <div className="inline-flex items-baseline gap-0.5 mb-6">
            <span className="font-display text-7xl font-semibold text-white">?</span>
            <span className="text-xl text-white/40 font-body">/100</span>
          </div>

          <h2 className="font-display text-3xl md:text-4xl font-semibold text-white leading-tight max-w-lg">
            How does your site score on lead capture?
          </h2>
          <p className="mt-4 text-base text-stone-light leading-relaxed max-w-md">
        ...
        {/* Light content section — fills bottom half */}
        <div className="px-8 pt-10 pb-12 flex-1 flex flex-col items-center justify-center min-h-[45vh]">
          <div className="w-full max-w-lg">
          {/* Three score categories */}
          <div className="grid grid-cols-3 gap-6 mb-8">
            <div className="text-center">
              <div className="w-12 h-12 mx-auto rounded-md bg-surface-alt border border-border flex items-center justify-center mb-3">
              ...
              <p className="text-sm font-medium text-ink font-body">Qualification</p>
            ...
            <div className="text-center">
              ...
              <p className="text-sm font-medium text-ink font-body">Speed</p>
            ...
            <div className="text-center">
              ...
              <p className="text-sm font-medium text-ink font-body">Routing</p>
