...
:host {
  ...
  --sb-input-border: ${a};
  --sb-hover-bg: ${c};
  --sb-accent-10: ${O(n.accentColor,.1)};
  --sb-accent-20: ${O(n.accentColor,.2)};
...
`}var Y="(prefers-reduced-motion: reduce)";function k(){return typeof window<"u"&&window.matchMedia(Y).matches}function Z(n,t,e){if(n.classList.add(t),k()){n.classList.remove(t);return}setTimeout(()=>{n.classList.remove(t)},e)}function D(n){n.classList.remove("sb-panel--hidden","sb-panel--closing"),n.style.animation="none",n.offsetHeight,n.style.animation=""}function $(n,t){if(k()){n.classList.add("sb-panel--hidden"),t();return}n.classList.add("sb-panel--closing");let e=()=>{n.removeEventListener("animationend",e),n.classList.add("sb-panel--hidden"),n.classList.remove("sb-panel--closing"),t()};n.addEventListener("animationend",e,{once:!0}),setTimeout(()=>{n.classList.contains("sb-panel--hidden")||(n.removeEventListener("animationend",e),n.classList.add("sb-panel--hidden"),n.classList.remove("sb-panel--closing"),t())},300)}function A(n,t){let e=n.firstElementChild;if(!e||k()){n.textContent="";let r=t();n.appendChild(r);return}e.classList.add("sb-step--exit");let i=()=>{e.removeEventListener("animationend",i),n.textContent="";let r=t();n.appendChild(r)};e.addEventListener("animationend",i,{once:!0}),setTimeout(()=>{if(n.contains(e)){e.removeEventListener("animationend",i),n.textContent="";let r=t();n.appendChild(r)}},250)}function B(n,t){if(k()){n.textContent="";let i=t();n.appendChild(i);return}n.textContent="";let e=t();e.classList.add("sb-step--back"),n.appendChild(e),setTimeout(()=>{e.classList.remove("sb-step--back")},350)}function H(n){Z(n,"sb-option--tapped",200)}function N(n){n.classList.remove("sb-trigger--hidden")}function W(n){n.classList.add("sb-trigger--hidden")}function U(n){n.style.animation="none",n.offsetHeight,n.style.animation=""}function m(n,...t){let e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("viewBox",n),e.setAttribute("aria-hidden","true"),e.setAttribute("focusable","false");for(let i of t)i(e);return e}function C(n,t){return e=>{let i=document.createElementNS("http://www.w3.org/2000/svg","path");if(i.setAttribute("d",n),t)for(let[r,s]of Object.entries(t))i.setAttribute(r,s);e.appendChild(i)}}function y(n,t,e,i){return r=>{let s=document.createElementNS("http://www.w3.org/2000/svg","line");s.setAttribute("x1",n),s.setAttribute("y1",t),s.setAttribute("x2",e),s.setAttribute("y2",i),r.appendChild(s)}}function J(n,t,e){return i=>{let r=document.createElementNS("http://www.w3.org/2000/svg","circle");r.setAttribute("cx",n),r.setAttribute("cy",t),r.setAttribute("r",e),i.appendChild(r)}}function Q(n){return t=>{let e=document.createElementNS("http://www.w3.org/2000/svg","polyline");e.setAttribute("points",n),t.appendChild(e)}}function tt(){return m("0 0 24 24",C("M5 12h14"),C("M12 5l7 7-7 7"))}function et(){return m("0 0 24 24",C("M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z",{fill:"currentColor",stroke:"none"}))}function it(){return m("0 0 24 24",y("12","5","12","19"),y("5","12","19","12"))}function nt(){return m("0 0 24 24",y("18","6","6","18"),y("6","6","18","18"))}function rt(){return m("0 0 24 24",Q("15 18 9 12 15 6"))}function st(){return m("0 0 24 24",C("M5 13l4 4L19 7"))}function ot(){return m("0 0 24 24",J("12","12","10"),y("12","8","12","12"),y("12","16","12.01","16"))}function at(){return m("0 0 16 16",C("M8 8a3 3 0 100-6 3 3 0 000 6zM2 14s-1 0-1-1 1-4 7-4 7 3 7 4-1 1-1 1H2z",{fill:"currentColor",stroke:"none"}))}function lt(n){switch(n){case"arrow":return tt();case"chat":return et();case"plus":return it();case"none":default:return null}}function o(n,t,e){let i=document.createElement(n);if(t&&(i.className=t),e)for(let[r,s]of Object.entries(e))i.setAttribute(r,s);return i}var S=class{constructor(t,e){this.config=null;this.triggerEl=null;this.panelEl=null;this.progressBar=null;this.stepCounter=null;this.contentEl=null;this.backBtn=null;this.ariaLiveRegion=null;this.previousActiveElement=null;this.boundKeyHandler=null;this.host=t,this.callbacks=e,this.shadow=t.attachShadow({mode:"open"})}init(t){this.config=t,this.injectStyles(t.theme),this.renderTrigger(t)}injectStyles(t){let e=document.createElement("style");e.textContent=F(t),this.shadow.appendChild(e)}renderTrigger(t){let e=o("button","sb-trigger sb-trigger--hidden",{type:"button","aria-label":t.theme.triggerText||"Open widget"});t.theme.triggerType==="tab"&&e.classList.add("sb-trigger--tab");let i=lt(t.theme.triggerIcon);if(i){let s=o("span","sb-trigger__icon");s.appendChild(i),e.appendChild(s)}let r=document.createTextNode(t.theme.triggerText||"Get Started");e.appendChild(r),e.addEventListener("click",()=>{this.callbacks.onTriggerClick()}),this.shadow.appendChild(e),this.triggerEl=e,requestAnimationFrame(()=>{N(e)})}showTrigger(){this.triggerEl&&this.triggerEl.classList.remove("sb-trigger--hidden")}hideTrigger(){this.triggerEl&&W(this.triggerEl)}openPanel(t,e){this.config&&(this.hideTrigger(),this.panelEl||this.buildPanel(),this.panelEl&&(D(this.panelEl),this.updateProgress(t,e),this.enableFocusTrap()))}closePanel(){this.panelEl&&($(this.panelEl,()=>{this.showTrigger()}),this.disableFocusTrap())}buildPanel(){var h;let t=o("div","sb-panel sb-panel--hidden",{role:"dialog","aria-label":"SignalBox Widget","aria-modal":"true"}),e=o("div","sb-header"),i=o("div","sb-header__left"),r=o("button","sb-header__back",{type:"button","aria-label":"Go back",style:"visibility: hidden;"});r.appendChild(rt()),r.addEventListener("click",()=>this.callbacks.onBack()),this.backBtn=r,i.appendChild(r);let s=o("span","sb-header__step");s.textContent="",this.stepCounter=s,i.appendChild(s),e.appendChild(i);let a=o("button","sb-header__close",{type:"button","aria-label":"Close widget"});a.appendChild(nt()),a.addEventListener("click",()=>this.callbacks.onClose()),e.appendChild(a),t.appendChild(e);let c=o("div","sb-progress",{role:"progressbar","aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":"0"}),p=o("div","sb-progress__bar");p.style.width="0%",c.appendChild(p),t.appendChild(c),this.progressBar=p;let l=o("div","sb-content");if(t.appendChild(l),this.contentEl=l,(h=this.config)!=null&&h.theme.showBranding){let b=o("div","sb-footer"),f=o("a","sb-footer__link",{href:"https://signalbox.io?ref=widget",target:"_blank",rel:"noopener noreferrer"});f.textContent="Powered by SignalBox",b.appendChild(f),t.appendChild(b)}let d=o("div","sb-sr-only",{"aria-live":"polite","aria-atomic":"true"});t.appendChild(d),this.ariaLiveRegion=d,this.shadow.appendChild(t),this.panelEl=t}updateProgress(t,e){let i=e+1,r=t+1,s=Math.round(r/i*100);if(this.progressBar){this.progressBar.style.width=`${s}%`;let a=this.progressBar.parentElement;a&&a.setAttribute("aria-valuenow",String(s))}this.stepCounter&&(this.stepCounter.textContent=`Step ${r} of ${i}`),this.backBtn&&(this.backBtn.style.visibility=t>0?"visible":"hidden"),this.ariaLiveRegion&&(this.ariaLiveRegion.textContent=`Step ${r} of ${i}`)}renderStep(t,e,i,r="forward"){if(!this.contentEl)return;this.updateProgress(e,i);let s=()=>{var l;let a=o("div","sb-step"),c=o("h2","sb-question");if(c.textContent=t.question,a.appendChild(c),t.description){let d=o("p","sb-description");d.textContent=t.description,a.appendChild(d)}let p=o("div","sb-options",{role:"radiogroup","aria-label":t.question});for(let d=0;d<t.options.length;d++){let h=t.options[d],b=o("button","sb-option",{type:"button",role:"radio","aria-checked":"false","data-option-id":h.id});if(h.icon){let u=o("span","sb-option__icon");u.textContent=h.icon,b.appendChild(u)}let f=o("span","sb-option__label");f.textContent=h.label,b.appendChild(f),b.addEventListener("click",()=>{H(b),setTimeout(()=>{this.callbacks.onOptionSelect(t.id,h.id,h.label,h.scoreWeight)},120)}),b.addEventListener("keydown",u=>{(u.key==="Enter"||u.key===" ")&&(u.preventDefault(),b.click())}),p.appendChild(b)}if(a.appendChild(p),(l=this.config)!=null&&l.theme.showSocialProof&&e===0&&this.config.submissionCount>=this.config.socialProofMin){let d=o("div","sb-social-proof"),h=o("span","sb-social-proof__icon");h.appendChild(at()),d.appendChild(h);let b=document.createTextNode(this.config.socialProofText.replace("{count}",String(this.config.submissionCount)));d.appendChild(b),a.appendChild(d)}return a};r==="backward"?B(this.contentEl,s):A(this.contentEl,s)}renderContactForm(t,e={},i=!1,r){if(!this.contentEl||!this.config)return;this.updateProgress(t,t);let s=()=>{let a=o("div","sb-contact"),c=o("h2","sb-contact__title");c.textContent="Almost done!",a.appendChild(c);let p=o("p","sb-contact__subtitle");p.textContent="Enter your details to see your results.",a.appendChild(p);let l=o("form","",{novalidate:"true",autocomplete:"on"}),d=this.createField("name","Name","text",!0,"Your name",e.name,r==null?void 0:r.name);l.appendChild(d);let h=this.createField("email","Email","email",!0,"you@example.com",e.email,r==null?void 0:r.email);if(l.appendChild(h),this.config.contactShowPhone){let x=this.createField("phone","Phone","tel",this.config.contactPhoneRequired,"(555) 123-4567",e.phone,r==null?void 0:r.phone);l.appendChild(x)}if(this.config.contactShowMessage){let x=this.createTextareaField("message","Message",this.config.contactMessageRequired,this.config.contactMessagePlaceholder||"Tell us more...",e.message,r==null?void 0:r.message);l.appendChild(x)}let b=o("div","sb-hp"),f=o("label");f.textContent="Leave this empty";let u=o("input","",{type:"text",name:"website",tabindex:"-1",autocomplete:"off","aria-hidden":"true"});b.appendChild(f),b.appendChild(u),l.appendChild(b);let w=o("button","sb-submit",{type:"submit"});if(i){w.setAttribute("disabled","true");let x=o("span","sb-submit__spinner");w.appendChild(x);let v=document.createTextNode("Submitting...");w.appendChild(v)}else w.textContent=this.config.contactSubmitText||"See My Results";return l.appendChild(w),l.addEventListener("submit",x=>{x.preventDefault();let v=new FormData(l),T={name:v.get("name")||"",email:v.get("email")||""};this.config.contactShowPhone&&(T.phone=v.get("phone")||""),this.config.contactShowMessage&&(T.message=v.get("message")||"");let G=v.get("website")||"";this.callbacks.onContactSubmit(T,G)}),a.appendChild(l),a};A(this.contentEl,s)}createField(t,e,i,r,s,a,c){let p=o("div","sb-field"),l=o("label","sb-field__label",{for:`sb-${t}`});if(l.textContent=e,r){let h=o("span","sb-field__required");h.textContent="*",l.appendChild(h)}p.appendChild(l);let d=o("input","sb-field__input",{type:i,name:t,id:`sb-${t}`,placeholder:s,autocomplete:t});if(r&&d.setAttribute("required","true"),c&&(d.value=c),a&&(d.classList.add("sb-field__input--error"),d.setAttribute("aria-invalid","true"),d.setAttribute("aria-describedby",`sb-${t}-error`)),p.appendChild(d),a){let h=o("div","sb-field__error",{id:`sb-${t}-error`,role:"alert"});h.textContent=a,p.appendChild(h)}return p}createTextareaField(t,e,i,r,s,a){let c=o("div","sb-field"),p=o("label","sb-field__label",{for:`sb-${t}`});if(p.textContent=e,i){let d=o("span","sb-field__required");d.textContent="*",p.appendChild(d)}c.appendChild(p);let l=o("textarea","sb-field__input sb-field__textarea",{name:t,id:`sb-${t}`,placeholder:r,rows:"3"});if(i&&l.setAttribute("required","true"),a&&(l.value=a),s&&(l.classList.add("sb-field__input--error"),l.setAttribute("aria-invalid","true"),l.setAttribute("aria-describedby",`sb-${t}-error`)),c.appendChild(l),s){let d=o("div","sb-field__error",{id:`sb-${t}-error`,role:"alert"});d.textContent=s,c.appendChild(d)}return c}renderConfirmation(t){if(!this.contentEl)return;if(this.backBtn&&(this.backBtn.style.visibility="hidden"),this.progressBar){this.progressBar.style.width="100%";let a=this.progressBar.parentElement;a&&a.setAttribute("aria-valuenow","100")}this.stepCounter&&(this.stepCounter.textContent="Complete"),this.contentEl.textContent="";let e=o("div","sb-confirmation"),i=o("div","sb-confirmation__check");i.appendChild(st()),e.appendChild(i);let r=o("h2","sb-confirmation__headline");r.textContent=t.headline,e.appendChild(r);let s=o("p","sb-confirmation__body");if(s.textContent=t.body,e.appendChild(s),t.ctaText&&t.ctaUrl){let a=o("a","sb-confirmation__cta",{href:t.ctaUrl,target:"_blank",rel:"noopener noreferrer",role:"button"});a.textContent=t.ctaText,a.addEventListener("click",c=>{c.preventDefault(),this.callbacks.onCtaClick(t.ctaUrl)}),e.appendChild(a)}this.contentEl.appendChild(e),U(e)}renderError(t){if(!this.contentEl)return;this.contentEl.textContent="";let e=o("div","sb-error"),i=o("div","sb-error__icon");i.appendChild(ot()),e.appendChild(i);let r=o("p","sb-error__message");r.textContent=t||"Something went wrong. Please try again.",e.appendChild(r);let s=o("button","sb-error__retry",{type:"button"});s.textContent="Try Again",s.addEventListener("click",()=>this.callbacks.onRetry()),e.appendChild(s),this.contentEl.appendChild(e)}renderLoading(){if(!this.contentEl)return;this.contentEl.textContent="";let t=o("div","sb-loading"),e=o("div","sb-loading__spinner"),i=o("span","sb-sr-only");i.textContent="Loading...",t.appendChild(e),t.appendChild(i),this.contentEl.appendChild(t)}renderDisabled(){for(;this.shadow.firstChild;)this.shadow.removeChild(this.shadow.firstChild)}renderExpiredFallback(){let t=this.shadow.querySelector("style");for(;this.shadow.firstChild;)this.shadow.removeChild(this.shadow.firstChild);t&&this.shadow.appendChild(t);let e=o("div","sb-panel",{role:"status",style:"position: fixed; bottom: 24px; right: 24px; z-index: 2147483647; padding: 20px; max-width: 320px;"}),i=o("p","",{style:"font-size: 14px; opacity: 0.7; line-height: 1.5; text-align: center; margin: 0;"});i.textContent="Please contact us directly",e.appendChild(i),this.shadow.appendChild(e)}enableFocusTrap(){this.previousActiveElement=document.activeElement,this.boundKeyHandler=t=>{if(t.key==="Escape"){t.preventDefault(),this.callbacks.onClose();return}if(t.key==="Tab"&&this.panelEl){let e=this.getFocusableElements();if(e.length===0)return;let i=e[0],r=e[e.length-1];t.shiftKey?(this.shadow.activeElement===i||!this.panelEl.contains(this.shadow.activeElement))&&(t.preventDefault(),r.focus()):(this.shadow.activeElement===r||!this.panelEl.contains(this.shadow.activeElement))&&(t.preventDefault(),i.focus())}},document.addEventListener("keydown",this.boundKeyHandler,!0),requestAnimationFrame(()=>{let e=this.getFocusableElements()[0];e&&e.focus()})}disableFocusTrap(){this.boundKeyHandler&&(document.removeEventListener("keydown",this.boundKeyHandler,!0),this.boundKeyHandler=null),this.previousActiveElement&&this.previousActiveElement instanceof HTMLElement&&(this.previousActiveElement.focus(),this.previousActiveElement=null)}getFocusableElements(){if(!this.panelEl)return[];let e=this.panelEl.querySelectorAll('button:not([disabled]), [href], input:not([disabled]):not([type="hidden"]):not([tabindex="-1"]), textarea:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])');return Array.from(e)}destroy(){for(this.disableFocusTrap();this.shadow.firstChild;)this.shadow.removeChild(this.shadow.firstChild);this.triggerEl=null,this.panelEl=null,this.progressBar=null,this.stepCounter=null,this.contentEl=null,this.backBtn=null,this.ariaLiveRegion=null}};var dt=/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+$/;function z(n,t){let e={},i=(n.name??"").trim();i?i.length>200&&(e.name="Name must be 200 characters or fewer."):e.name="Name is required.";let r=(n.email??"").trim();if(r?dt.test(r)||(e.email="Please enter a valid email address."):e.email="Email is required.",t.contactShowPhone){let s=(n.phone??"").trim();t.contactPhoneRequired&&!s?e.phone="Phone number is required.":s&&s.length>30&&(e.phone="Phone must be 30 characters or fewer.")}if(t.contactShowMessage){let s=(n.message??"").trim();t.contactMessageRequired&&!s?e.message="Message is required.":s&&s.length>2e3&&(e.message="Message must be 2000 characters or fewer.")}return e}function V(n){return Object.keys(n).length>0}var ct="https://signalbox.io";async function pt(n,t){let e=Math.random().toString(36).substring(2,10),i=`${n}:${t}:${e}`,r=new TextEncoder,s=await crypto.subtle.digest("SHA-256",r.encode(i)),c=Array.from(new Uint8Array(s)).map(p=>p.toString(16).padStart(2,"0")).join("");return`sb_${n.slice(0,8)}_${c}`}function ht(){try{let n=new URLSearchParams(window.location.search),t={},e=n.get("utm_source"),i=n.get("utm_medium"),r=n.get("utm_campaign");return e&&(t.utmSource=e),i&&(t.utmMedium=i),r&&(t.utmCampaign=r),t}catch{return{}}}function E(n,t,e,i){let r={widgetKey:t,event:e};i!==void 0&&(r.stepIndex=i);try{fetch(`${n}/api/v1/widget/track`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r),keepalive:!0}).catch(()=>{})}catch{}}var I=class{constructor(t,e){this.stepDirection="forward";this.validationErrors={};this.widgetKey=t,this.apiUrl=e,this.machine=new _}async start(){let t=`sb-root-${this.widgetKey}`;if(document.getElementById(t))return;let e=document.createElement("div");e.id=t,e.style.position="fixed",e.style.zIndex="2147483647",e.style.top="0",e.style.left="0",e.style.width="0",e.style.height="0",e.style.overflow="visible",e.style.pointerEvents="none",document.body.appendChild(e),this.renderer=new S(e,{onTriggerClick:()=>this.handleTriggerClick(),onClose:()=>this.handleClose(),onOptionSelect:(i,r,s,a)=>this.handleOptionSelect(i,r,s,a),onBack:()=>this.handleBack(),onContactSubmit:(i,r)=>this.handleContactSubmit(i,r),onRetry:()=>this.handleRetry(),onCtaClick:i=>this.handleCtaClick(i)}),this.machine.init();try{let i=await L(this.widgetKey,this.apiUrl);this.machine.configLoaded(i),this.renderer.init(i),E(this.apiUrl,this.widgetKey,"impression")}catch(i){if(i instanceof g){if(i.code==="INACTIVE"){this.machine.widgetDisabled(),this.renderer.renderDisabled();return}if(i.code==="EXPIRED"){this.machine.widgetDisabled(),this.renderer.renderExpiredFallback();return}this.machine.fetchFailed(i.message)}else this.machine.fetchFailed("Failed to load widget configuration.")}}handleTriggerClick(){let t=this.machine.getContext();if(t.state!=="ready")return;this.machine.open(),E(this.apiUrl,this.widgetKey,"open");let e=t.config;if(!e||e.steps.length===0)return;let i=e.steps.length;this.renderer.openPanel(0,i),this.stepDirection="forward",E(this.apiUrl,this.widgetKey,"step_view",0),this.renderCurrentView()}handleClose(){let t=this.machine.getState();(t==="open"||t==="complete"||t==="error")&&(this.renderer.closePanel(),t==="complete"?this.machine.reset():t==="error"?this.machine.retry():this.machine.close())}handleOptionSelect(t,e,i,r){let s=this.machine.getContext();if(s.state!=="open"||!s.config)return;let a=s.config.steps.find(d=>d.id===t);if(!a)return;let c={stepId:t,optionId:e,question:a.question,label:i,scoreWeight:r};this.stepDirection="forward",this.machine.selectOption(c);let p=this.machine.getContext(),l=p.currentStepIndex;p.config&&l<p.config.steps.length?E(this.apiUrl,this.widgetKey,"step_view",l):E(this.apiUrl,this.widgetKey,"completion"),this.renderCurrentView()}handleBack(){let t=this.machine.getContext();t.state==="open"&&(this.stepDirection="backward",this.machine.isOnContactStep()?t.answers.length>0&&this.machine.goBack():this.machine.goBack(),this.renderCurrentView())}async handleContactSubmit(t,e){var s,a;let i=this.machine.getContext();if(i.state!=="open"||!i.config)return;this.machine.setContact(t);let r=z(t,i.config);if(this.validationErrors=r,V(r)){this.renderer.renderContactForm(i.config.steps.length,r,!1,t);return}this.machine.submit(),this.renderer.renderContactForm(i.config.steps.length,{},!0,t);try{let c=await pt(this.widgetKey,i.loadedAt),p=ht(),l={widgetKey:this.widgetKey,answers:i.answers.map(b=>({stepId:b.stepId,optionId:b.optionId})),visitorName:t.name.trim(),visitorEmail:t.email.trim(),challengeToken:c,loadedAt:i.loadedAt,sourceUrl:window.location.href,referrer:document.referrer||"",...p};(s=t.phone)!=null&&s.trim()&&(l.visitorPhone=t.phone.trim()),(a=t.message)!=null&&a.trim()&&(l.visitorMessage=t.message.trim()),e&&(l.honeypot=e);let d=await P(l,this.apiUrl);this.machine.submitSuccess(d.tier);let h=i.config.confirmation[d.tier];this.renderer.renderConfirmation(h)}catch(c){if(c instanceof g&&c.code==="DUPLICATE"){let l="warm";this.machine.submitSuccess(l);let d=i.config.confirmation[l];this.renderer.renderConfirmation(d);return}let p="Something went wrong. Please try again.";c instanceof g&&(p=c.message),this.machine.submitFailed(p),this.renderer.renderError(p)}}handleRetry(){let t=this.machine.getContext();if(t.state==="error")if(this.machine.retry(),t.config){this.machine.open();let e=t.config.steps.length;this.renderer.openPanel(0,e),this.stepDirection="forward",this.renderCurrentView()}else this.retryFetchConfig()}async retryFetchConfig(){this.machine.init();try{let t=await L(this.widgetKey,this.apiUrl);this.machine.configLoaded(t),this.renderer.init(t)}catch(t){if(t instanceof g){if(t.code==="INACTIVE"){this.machine.widgetDisabled(),this.renderer.renderDisabled();return}if(t.code==="EXPIRED"){this.machine.widgetDisabled(),this.renderer.renderExpiredFallback();return}this.machine.fetchFailed(t.message)}else this.machine.fetchFailed("Failed to load widget configuration.")}}handleCtaClick(t){window.open(t,"_blank","noopener,noreferrer")}renderCurrentView(){let t=this.machine.getContext();if(!t.config)return;let e=t.config.steps.length,i=t.currentStepIndex;if(this.machine.isOnContactStep()){this.renderer.updateProgress(e,e),this.renderer.renderContactForm(e,this.validationErrors,!1,t.contact);return}let r=t.config.steps[i];r&&this.renderer.renderStep(r,i,e,this.stepDirection)}};(function(){function n(){let t=window.SignalBoxConfig;if(!t||!t.key)return;let e=t.apiUrl||ct;new I(t.key,e).start()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n,{once:!0}):n()})();})();
