...
`}var re="(prefers-reduced-motion: reduce)";function M(){return typeof window<"u"&&window.matchMedia(re).matches}function oe(i,e,t){if(i.classList.add(e),M()){i.classList.remove(e);return}setTimeout(()=>{i.classList.remove(e)},t)}function q(i){i.classList.remove("sb-panel--hidden","sb-panel--closing"),i.style.animation="none",i.offsetHeight,i.style.animation=""}function V(i,e){if(M()){i.classList.add("sb-panel--hidden"),e();return}i.classList.add("sb-panel--closing");let t=()=>{i.removeEventListener("animationend",t),i.classList.add("sb-panel--hidden"),i.classList.remove("sb-panel--closing"),e()};i.addEventListener("animationend",t,{once:!0}),setTimeout(()=>{i.classList.contains("sb-panel--hidden")||(i.removeEventListener("animationend",t),i.classList.add("sb-panel--hidden"),i.classList.remove("sb-panel--closing"),e())},300)}function B(i,e){let t=i.firstElementChild;if(!t||M()){i.textContent="";let r=e();i.appendChild(r);return}t.classList.add("sb-step--exit");let n=()=>{t.removeEventListener("animationend",n),i.textContent="";let r=e();i.appendChild(r)};t.addEventListener("animationend",n,{once:!0}),setTimeout(()=>{if(i.contains(t)){t.removeEventListener("animationend",n),i.textContent="";let r=e();i.appendChild(r)}},250)}function G(i,e){if(M()){i.textContent="";let n=e();i.appendChild(n);return}i.textContent="";let t=e();t.classList.add("sb-step--back"),i.appendChild(t),setTimeout(()=>{t.classList.remove("sb-step--back")},350)}function K(i){oe(i,"sb-option--tapped",200)}function j(i){i.classList.remove("sb-trigger--hidden")}function Y(i){i.classList.add("sb-trigger--hidden")}function X(i){i.style.animation="none",i.offsetHeight,i.style.animation=""}function f(i,...e){let t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.setAttribute("viewBox",i),t.setAttribute("aria-hidden","true"),t.setAttribute("focusable","false");for(let n of e)n(t);return t}function _(i,e){return t=>{let n=document.createElementNS("http://www.w3.org/2000/svg","path");if(n.setAttribute("d",i),e)for(let[r,o]of Object.entries(e))n.setAttribute(r,o);t.appendChild(n)}}function y(i,e,t,n){return r=>{let o=document.createElementNS("http://www.w3.org/2000/svg","line");o.setAttribute("x1",i),o.setAttribute("y1",e),o.setAttribute("x2",t),o.setAttribute("y2",n),r.appendChild(o)}}function se(i,e,t){return n=>{let r=document.createElementNS("http://www.w3.org/2000/svg","circle");r.setAttribute("cx",i),r.setAttribute("cy",e),r.setAttribute("r",t),n.appendChild(r)}}function ae(i){return e=>{let t=document.createElementNS("http://www.w3.org/2000/svg","polyline");t.setAttribute("points",i),e.appendChild(t)}}function le(){return f("0 0 24 24",_("M5 12h14"),_("M12 5l7 7-7 7"))}function de(){return f("0 0 24 24",_("M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z",{fill:"currentColor",stroke:"none"}))}function ce(){return f("0 0 24 24",y("12","5","12","19"),y("5","12","19","12"))}function pe(){return f("0 0 24 24",y("18","6","6","18"),y("6","6","18","18"))}function he(){return f("0 0 24 24",ae("15 18 9 12 15 6"))}function be(){return f("0 0 24 24",_("M5 13l4 4L19 7"))}function me(){return f("0 0 24 24",se("12","12","10"),y("12","8","12","12"),y("12","16","12.01","16"))}function ge(){return f("0 0 16 16",_("M8 8a3 3 0 100-6 3 3 0 000 6zM2 14s-1 0-1-1 1-4 7-4 7 3 7 4-1 1-1 1H2z",{fill:"currentColor",stroke:"none"}))}function ue(i){switch(i){case"arrow":return le();case"chat":return de();case"plus":return ce();case"none":default:return null}}function a(i,e,t){let n=document.createElement(i);if(e&&(n.className=e),t)for(let[r,o]of Object.entries(t))n.setAttribute(r,o);return n}var L=class{constructor(e,t){this.config=null;this.triggerEl=null;this.panelEl=null;this.progressBar=null;this.stepCounter=null;this.contentEl=null;this.backBtn=null;this.ariaLiveRegion=null;this.previousActiveElement=null;this.boundKeyHandler=null;this.host=e,this.callbacks=t,this.shadow=e.attachShadow({mode:"open"})}init(e){this.config=e,this.injectStyles(e.theme),this.renderTrigger(e)}injectStyles(e){let t=document.createElement("style");t.textContent=U(e),this.shadow.appendChild(t)}renderTrigger(e){let t=a("button","sb-trigger sb-trigger--hidden",{type:"button","aria-label":e.theme.triggerText||"Open widget"});e.theme.triggerType==="tab"&&t.classList.add("sb-trigger--tab");let n=ue(e.theme.triggerIcon);if(n){let o=a("span","sb-trigger__icon");o.appendChild(n),t.appendChild(o)}let r=document.createTextNode(e.theme.triggerText||"Get Started");t.appendChild(r),t.addEventListener("click",()=>{this.callbacks.onTriggerClick()}),this.shadow.appendChild(t),this.triggerEl=t,requestAnimationFrame(()=>{j(t)})}showTrigger(){this.triggerEl&&this.triggerEl.classList.remove("sb-trigger--hidden")}hideTrigger(){this.triggerEl&&Y(this.triggerEl)}openPanel(e,t){this.config&&(this.hideTrigger(),this.panelEl||this.buildPanel(),this.panelEl&&(q(this.panelEl),this.updateProgress(e,t),this.enableFocusTrap()))}closePanel(){this.panelEl&&(V(this.panelEl,()=>{this.showTrigger()}),this.disableFocusTrap())}buildPanel(){var s;let e=a("div","sb-panel sb-panel--hidden",{role:"dialog","aria-label":"SignalBox Widget","aria-modal":"true"}),t=a("div","sb-header"),n=a("div","sb-header__left"),r=a("button","sb-header__back",{type:"button","aria-label":"Go back",style:"visibility: hidden;"});r.appendChild(he()),r.addEventListener("click",()=>this.callbacks.onBack()),this.backBtn=r,n.appendChild(r);let o=a("span","sb-header__step");o.textContent="",this.stepCounter=o,n.appendChild(o),t.appendChild(n);let l=a("button","sb-header__close",{type:"button","aria-label":"Close widget"});l.appendChild(pe()),l.addEventListener("click",()=>this.callbacks.onClose()),t.appendChild(l),e.appendChild(t);let p=a("div","sb-progress",{role:"progressbar","aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":"0"}),h=a("div","sb-progress__bar");h.style.width="0%",p.appendChild(h),e.appendChild(p),this.progressBar=h;let c=a("div","sb-content");if(e.appendChild(c),this.contentEl=c,(s=this.config)!=null&&s.theme.showBranding){let b=a("div","sb-footer"),g=a("a","sb-footer__link",{href:"https://signalbox.io?ref=widget",target:"_blank",rel:"noopener noreferrer"});g.textContent="Powered by SignalBox",b.appendChild(g),e.appendChild(b)}let d=a("div","sb-sr-only",{"aria-live":"polite","aria-atomic":"true"});e.appendChild(d),this.ariaLiveRegion=d,e.addEventListener("keydown",b=>{let g=parseInt(b.key,10);if(g>=1&&g<=9){let u=e.querySelectorAll(".sb-option")[g-1];u&&(b.preventDefault(),u.click())}}),this.shadow.appendChild(e),this.panelEl=e}updateProgress(e,t){let n=t+1,r=e+1,o=Math.round(r/n*100);if(this.progressBar){this.progressBar.style.width=`${o}%`;let l=this.progressBar.parentElement;l&&l.setAttribute("aria-valuenow",String(o))}this.stepCounter&&(this.stepCounter.textContent=`Step ${r} of ${n}`),this.backBtn&&(this.backBtn.style.visibility=e>0?"visible":"hidden"),this.ariaLiveRegion&&(this.ariaLiveRegion.textContent=`Step ${r} of ${n}`)}renderStep(e,t,n,r="forward"){if(!this.contentEl)return;this.updateProgress(t,n);let o=()=>{var c;let l=a("div","sb-step"),p=a("h2","sb-question");if(p.textContent=e.question,l.appendChild(p),e.description){let d=a("p","sb-description");d.textContent=e.description,l.appendChild(d)}let h=a("div","sb-options",{role:"radiogroup","aria-label":e.question});for(let d=0;d<e.options.length;d++){let s=e.options[d],b=a("button","sb-option",{type:"button",role:"radio","aria-checked":"false","data-option-id":s.id}),g=a("span","sb-option__num");if(g.textContent=String(d+1),b.appendChild(g),s.icon){let u=a("span","sb-option__icon");u.textContent=s.icon,b.appendChild(u)}let w=a("span","sb-option__label");w.textContent=s.label,b.appendChild(w),b.addEventListener("click",()=>{K(b),setTimeout(()=>{this.callbacks.onOptionSelect(e.id,s.id,s.label,s.scoreWeight)},120)}),b.addEventListener("keydown",u=>{(u.key==="Enter"||u.key===" ")&&(u.preventDefault(),b.click())}),h.appendChild(b)}if(l.appendChild(h),(c=this.config)!=null&&c.theme.showSocialProof&&t===0&&this.config.submissionCount>=this.config.socialProofMin){let d=a("div","sb-social-proof"),s=a("span","sb-social-proof__icon");s.appendChild(ge()),d.appendChild(s);let b=document.createTextNode(this.config.socialProofText.replace("{count}",String(this.config.submissionCount)));d.appendChild(b),l.appendChild(d)}return l};r==="backward"?G(this.contentEl,o):B(this.contentEl,o)}renderContactForm(e,t={},n=!1,r){if(!this.contentEl||!this.config)return;this.updateProgress(e,e);let o=()=>{let l=a("div","sb-contact"),p=a("h2","sb-contact__title");p.textContent="Almost done!",l.appendChild(p);let h=a("p","sb-contact__subtitle");h.textContent="Enter your details to see your results.",l.appendChild(h);let c=a("form","",{novalidate:"true",autocomplete:"on"}),d=this.createField("name","Name","text",!0,"Your name",t.name,r==null?void 0:r.name);c.appendChild(d);let s=this.createField("email","Email","email",!0,"you@example.com",t.email,r==null?void 0:r.email);if(c.appendChild(s),this.config.contactShowPhone){let x=this.createField("phone","Phone","tel",this.config.contactPhoneRequired,"(555) 123-4567",t.phone,r==null?void 0:r.phone);c.appendChild(x)}if(this.config.contactShowMessage){let x=this.createTextareaField("message","Message",this.config.contactMessageRequired,this.config.contactMessagePlaceholder||"Tell us more...",t.message,r==null?void 0:r.message);c.appendChild(x)}let b=a("div","sb-hp"),g=a("label");g.textContent="Leave this empty";let w=a("input","",{type:"text",name:"website",tabindex:"-1",autocomplete:"off","aria-hidden":"true"});b.appendChild(g),b.appendChild(w),c.appendChild(b);let u=a("div","sb-consent"),I=a("label","sb-consent__label"),A=a("input","sb-consent__check",{type:"checkbox",name:"consent",required:"true"});I.appendChild(A);let P=a("span","sb-consent__text");P.textContent="I agree to the processing of my data and acknowledge the ";let $=a("a","sb-consent__link",{href:"/privacy",target:"_blank",rel:"noopener noreferrer"});$.textContent="Privacy Policy",P.appendChild($),I.appendChild(P),u.appendChild(I);let C=a("p","sb-field__error sb-consent__error");C.style.display="none",C.textContent="You must agree before submitting.",u.appendChild(C),c.appendChild(u);let E=a("button","sb-submit",{type:"submit"});if(n){E.setAttribute("disabled","true");let x=a("span","sb-submit__spinner");E.appendChild(x);let v=document.createTextNode("Submitting...");E.appendChild(v)}else E.textContent=this.config.contactSubmitText||"See My Results";return c.appendChild(E),c.addEventListener("submit",x=>{if(x.preventDefault(),!A.checked){C.style.display="block",A.focus();return}C.style.display="none";let v=new FormData(c),S=F=>F.replace(/<[^>]*>?/g,"").trim(),R={name:S(v.get("name")||""),email:S(v.get("email")||"").toLowerCase()};if(this.config.contactShowPhone){let F=S(v.get("phone")||"");R.phone=F.replace(/[^+\d\s().-]/g,"")}this.config.contactShowMessage&&(R.message=S(v.get("message")||""));let Q=v.get("website")||"";this.callbacks.onContactSubmit(R,Q)}),l.appendChild(c),l};B(this.contentEl,o)}createField(e,t,n,r,o,l,p){let h=a("div","sb-field"),c=a("label","sb-field__label",{for:`sb-${e}`});if(c.textContent=t,r){let s=a("span","sb-field__required");s.textContent="*",c.appendChild(s)}h.appendChild(c);let d=a("input","sb-field__input",{type:n,name:e,id:`sb-${e}`,placeholder:o,autocomplete:e});if(r&&d.setAttribute("required","true"),p&&(d.value=p),n==="tel"&&(d.setAttribute("inputmode","tel"),d.addEventListener("input",()=>{let s=d.value.replace(/\D/g,"").slice(0,10);s.length===0?d.value="":s.length<=3?d.value=`(${s}`:s.length<=6?d.value=`(${s.slice(0,3)}) ${s.slice(3)}`:d.value=`(${s.slice(0,3)}) ${s.slice(3,6)}-${s.slice(6)}`})),l&&(d.classList.add("sb-field__input--error"),d.setAttribute("aria-invalid","true"),d.setAttribute("aria-describedby",`sb-${e}-error`)),h.appendChild(d),l){let s=a("div","sb-field__error",{id:`sb-${e}-error`,role:"alert"});s.textContent=l,h.appendChild(s)}return h}createTextareaField(e,t,n,r,o,l){let p=a("div","sb-field"),h=a("label","sb-field__label",{for:`sb-${e}`});if(h.textContent=t,n){let d=a("span","sb-field__required");d.textContent="*",h.appendChild(d)}p.appendChild(h);let c=a("textarea","sb-field__input sb-field__textarea",{name:e,id:`sb-${e}`,placeholder:r,rows:"3"});if(n&&c.setAttribute("required","true"),l&&(c.value=l),o&&(c.classList.add("sb-field__input--error"),c.setAttribute("aria-invalid","true"),c.setAttribute("aria-describedby",`sb-${e}-error`)),p.appendChild(c),o){let d=a("div","sb-field__error",{id:`sb-${e}-error`,role:"alert"});d.textContent=o,p.appendChild(d)}return p}renderConfirmation(e){if(!this.contentEl)return;if(this.backBtn&&(this.backBtn.style.visibility="hidden"),this.progressBar){this.progressBar.style.width="100%";let l=this.progressBar.parentElement;l&&l.setAttribute("aria-valuenow","100")}this.stepCounter&&(this.stepCounter.textContent="Complete"),this.contentEl.textContent="";let t=a("div","sb-confirmation"),n=a("div","sb-confirmation__check");n.appendChild(be()),t.appendChild(n);let r=a("h2","sb-confirmation__headline");r.textContent=e.headline,t.appendChild(r);let o=a("p","sb-confirmation__body");if(o.textContent=e.body,t.appendChild(o),e.ctaText&&e.ctaUrl){let l=a("a","sb-confirmation__cta",{href:e.ctaUrl,target:"_blank",rel:"noopener noreferrer",role:"button"});l.textContent=e.ctaText,l.addEventListener("click",p=>{p.preventDefault(),this.callbacks.onCtaClick(e.ctaUrl)}),t.appendChild(l)}this.contentEl.appendChild(t),X(t),this.launchConfetti()}launchConfetti(){let e=document.createElement("canvas");e.style.cssText="position:fixed;inset:0;z-index:2147483647;pointer-events:none;width:100vw;height:100vh;",document.body.appendChild(e),e.width=window.innerWidth,e.height=window.innerHeight;let t=e.getContext("2d");if(!t){e.remove();return}let n=["#3B82F6","#10B981","#F59E0B","#EF4444","#8B5CF6","#EC4899","#06B6D4","#F97316"],r=[],o=e.width,l=e.height;for(let s=0;s<100;s++){let b=Math.random()*Math.PI*2,g=2+Math.random()*5;r.push({x:o/2+(Math.random()-.5)*200,y:l/2+(Math.random()-.5)*100,w:8+Math.random()*10,h:5+Math.random()*10,vx:Math.cos(b)*g,vy:Math.sin(b)*g-3,rot:Math.random()*Math.PI*2,vr:(Math.random()-.5)*.15,color:n[Math.floor(Math.random()*n.length)]??"#3B82F6",life:1,shape:Math.floor(Math.random()*3),sway:Math.random()*Math.PI*2,swaySpeed:.02+Math.random()*.03,delay:0})}for(let s=0;s<80;s++){let b=s%2===0;r.push({x:b?-10:o+10,y:l*.7+Math.random()*l*.3,w:6+Math.random()*8,h:4+Math.random()*8,vx:(b?1:-1)*(3+Math.random()*5),vy:-(4+Math.random()*6),rot:Math.random()*Math.PI*2,vr:(Math.random()-.5)*.2,color:n[Math.floor(Math.random()*n.length)]??"#10B981",life:1,shape:Math.floor(Math.random()*3),sway:Math.random()*Math.PI*2,swaySpeed:.015+Math.random()*.02,delay:30+Math.floor(Math.random()*20)})}for(let s=0;s<120;s++)r.push({x:Math.random()*o,y:-20-Math.random()*200,w:5+Math.random()*7,h:3+Math.random()*6,vx:(Math.random()-.5)*1.5,vy:.5+Math.random()*1.5,rot:Math.random()*Math.PI*2,vr:(Math.random()-.5)*.1,color:n[Math.floor(Math.random()*n.length)]??"#F59E0B",life:1,shape:Math.floor(Math.random()*3),sway:Math.random()*Math.PI*2,swaySpeed:.01+Math.random()*.02,delay:60+Math.floor(Math.random()*60)});let p=s=>{for(let b=0;b<12;b++)r.push({x:Math.random()*o,y:l+20,w:7+Math.random()*9,h:5+Math.random()*7,vx:(Math.random()-.5)*2,vy:-(3+Math.random()*4),rot:Math.random()*Math.PI*2,vr:(Math.random()-.5)*.12,color:n[Math.floor(Math.random()*n.length)]??"#8B5CF6",life:1,shape:Math.floor(Math.random()*3),sway:Math.random()*Math.PI*2,swaySpeed:.01+Math.random()*.015,delay:s+Math.floor(Math.random()*30)})};p(240),p(480),p(720);let h=0,c=900,d=()=>{h++,t.clearRect(0,0,e.width,e.height);for(let s of r)h<s.delay||(s.sway+=s.swaySpeed,s.x+=s.vx+Math.sin(s.sway)*.5,s.vy+=.04,s.y+=s.vy,s.rot+=s.vr,s.vx*=.995,s.vr*=.998,h>c-80&&(s.life-=.0125),!(s.life<=0||s.y>e.height+20)&&(t.save(),t.translate(s.x,s.y),t.rotate(s.rot),t.globalAlpha=Math.max(0,s.life),t.fillStyle=s.color,s.shape===0?t.fillRect(-s.w/2,-s.h/2,s.w,s.h):s.shape===1?(t.beginPath(),t.arc(0,0,s.w/2,0,Math.PI*2),t.fill()):(t.beginPath(),t.moveTo(0,-s.h/2),t.lineTo(s.w/2,s.h/2),t.lineTo(-s.w/2,s.h/2),t.closePath(),t.fill()),t.restore()));h<c?requestAnimationFrame(d):e.remove()};requestAnimationFrame(d)}renderError(e){if(!this.contentEl)return;this.contentEl.textContent="";let t=a("div","sb-error"),n=a("div","sb-error__icon");n.appendChild(me()),t.appendChild(n);let r=a("p","sb-error__message");r.textContent=e||"Something went wrong. Please try again.",t.appendChild(r);let o=a("button","sb-error__retry",{type:"button"});o.textContent="Try Again",o.addEventListener("click",()=>this.callbacks.onRetry()),t.appendChild(o),this.contentEl.appendChild(t)}renderLoading(){if(!this.contentEl)return;this.contentEl.textContent="";let e=a("div","sb-loading"),t=a("div","sb-loading__spinner"),n=a("span","sb-sr-only");n.textContent="Loading...",e.appendChild(t),e.appendChild(n),this.contentEl.appendChild(e)}renderDisabled(){for(;this.shadow.firstChild;)this.shadow.removeChild(this.shadow.firstChild)}renderExpiredFallback(){let e=this.shadow.querySelector("style");for(;this.shadow.firstChild;)this.shadow.removeChild(this.shadow.firstChild);e&&this.shadow.appendChild(e);let t=a("div","sb-panel",{role:"status",style:"position: fixed; bottom: 24px; right: 24px; z-index: 2147483647; padding: 20px; max-width: 320px;"}),n=a("p","",{style:"font-size: 14px; opacity: 0.7; line-height: 1.5; text-align: center; margin: 0;"});n.textContent="Please contact us directly",t.appendChild(n),this.shadow.appendChild(t)}enableFocusTrap(){this.previousActiveElement=document.activeElement,this.boundKeyHandler=e=>{if(e.key==="Escape"){e.preventDefault(),this.callbacks.onClose();return}if(e.key==="Tab"&&this.panelEl){let t=this.getFocusableElements();if(t.length===0)return;let n=t[0],r=t[t.length-1];e.shiftKey?(this.shadow.activeElement===n||!this.panelEl.contains(this.shadow.activeElement))&&(e.preventDefault(),r.focus()):(this.shadow.activeElement===r||!this.panelEl.contains(this.shadow.activeElement))&&(e.preventDefault(),n.focus())}},document.addEventListener("keydown",this.boundKeyHandler,!0),requestAnimationFrame(()=>{let t=this.getFocusableElements()[0];t&&t.focus()})}disableFocusTrap(){this.boundKeyHandler&&(document.removeEventListener("keydown",this.boundKeyHandler,!0),this.boundKeyHandler=null),this.previousActiveElement&&this.previousActiveElement instanceof HTMLElement&&(this.previousActiveElement.focus(),this.previousActiveElement=null)}getFocusableElements(){if(!this.panelEl)return[];let t=this.panelEl.querySelectorAll('button:not([disabled]), [href], input:not([disabled]):not([type="hidden"]):not([tabindex="-1"]), textarea:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])');return Array.from(t)}showTeaser(e){if(!this.triggerEl)return;let t=this.shadow.querySelector(".sb-teaser");t&&t.remove();let n=document.createElement("div");n.className="sb-teaser",n.setAttribute("role","status"),n.style.cssText=`
