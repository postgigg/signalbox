...
export const metadata: Metadata = {
  ...
  description: 'HawkLeads pricing starts at $99/month. 14-day free trial on every plan. No credit card required. Starter, Pro, and Agency tiers for solo operators to large agencies.',
