...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://signalbox.netlify.app/templates' },
  openGraph: {
    title: 'SignalBox Flow Templates — Start Scoring Leads in Minutes',
    description: 'Pre-built qualification flows for every industry. Pick a template, customize your questions, install the widget.',
    url: 'https://signalbox.netlify.app/templates',
  },
};
